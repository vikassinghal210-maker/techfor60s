...
Before you set your master password, use our free [Password Strength Checker](/tools/password-checker) to make sure it is strong enough. And if you want to check whether any of your accounts have been compromised, try the [Data Breach Checker](/tools/data-breach-checker). For more online safety tips, explore our [Scam Checker](/tools/scam-checker) tool.
## Related reading
